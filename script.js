...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const header = document.querySelector('header'); // o .navbar, l'elemento che contiene il brand

  // espongo l’altezza della navbar come CSS var (serve al posizionamento fisso del menu)
  function setNavH(){
  ...
  navToggle?.addEventListener('click', () => {
    ...
    document.body.classList.toggle('menu-open', open); // blocca lo scroll sotto
  });
